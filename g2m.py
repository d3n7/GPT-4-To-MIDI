...
#settings
openaiKey = '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'
...
parser.add_argument('-n', '--num', help='generate n number of outputs and merge them (context unaware)', type=int, default=1)
...
while 1:
    ...
    for i in re.findall(r'(?<![A-Za-z\d])([A-G](?:#|b)?\d-(?:\d+\/\d+|\d+))(?![A-Za-z\d])', response):
